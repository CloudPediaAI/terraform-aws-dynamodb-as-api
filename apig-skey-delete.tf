...
resource "aws_api_gateway_method_response" "skey_delete_method_response_401" {
  for_each = aws_api_gateway_method.skey_delete
...
resource "aws_api_gateway_integration_response" "skey_delete_int_response_401" {
  for_each = aws_api_gateway_integration.skey_delete_int
  ...
  status_code       = aws_api_gateway_method_response.skey_delete_method_response_401[each.key].status_code
