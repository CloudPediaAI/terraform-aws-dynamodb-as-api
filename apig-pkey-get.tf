...
resource "aws_api_gateway_method_response" "pkey_get_method_response_401" {
  for_each = aws_api_gateway_method.pkey_get
...
resource "aws_api_gateway_integration_response" "pkey_get_int_response_401" {
  for_each = aws_api_gateway_integration.pkey_get_int
  ...
  status_code       = aws_api_gateway_method_response.pkey_get_method_response_401[each.key].status_code
