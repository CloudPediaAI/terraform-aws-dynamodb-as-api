...
resource "aws_api_gateway_method_response" "skey_delete_method_response" {
...
# resource "aws_api_gateway_integration_response" "skey_delete_int_response" {
...
#   status_code = aws_api_gateway_method_response.skey_delete_method_response[each.key].status_code
#   response_parameters = {
